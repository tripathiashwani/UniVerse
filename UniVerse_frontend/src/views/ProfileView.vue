        ...
        <div class="bg-white border border-gray-200 rounded-lg" v-if="user.id === userStore.user.id">
          <form @submit.prevent="submitform" method="post">
            ...
            <div class="p-4 border-t border-gray-100 flex flex-col sm:flex-row justify-between space-y-2 sm:space-y-0">
              <button type="button"
                class="w-full sm:w-auto py-2 px-4 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition duration-300">
                Attach image
              </button>
              <button type="submit"
                class="w-full sm:w-auto py-2 px-4 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition duration-300">
                Post
              </button>
            </div>
          </form>
